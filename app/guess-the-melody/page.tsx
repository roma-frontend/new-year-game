...
const GuessTheMelody = () => {
  ...
  const wishes = [
    '🎤 քորել հաղթողի մեջքը',
    '💃 կոֆե դնել հաղթողի համար',
    '😂 պատմել 18+ անեկդոտ',
    '💪 անել 15 հատ ժիմ գետնին',
    '💋 համբուրել Նունեի ճակատը',
    '🌟 շպարել Լինայի դեմքին',
    '📸 երգել սերենադ տղաների համար',
    '👏 արտասանել ծափահարելով 30 վայրկյան',
    '🎭 նմանակել հաղթողին',
    '🎨 նկարել հաղթողի դեմքին',
    '🕺 սովորեցնել պարել բոլորին',
    '🎁 խմել 1 շոթ օղի',
  ];
            ...
            <Card className="p-12 bg-white/95 backdrop-blur-xl border-8 border-yellow-400 shadow-2xl transform hover:scale-105 transition-all">
              ...
              <div className="grid grid-cols-4 gap-6 mb-8">
                ...
                <div className="bg-gradient-to-br from-green-500 to-emerald-500 p-6 rounded-xl shadow-xl">
                  ...
                  <div className="text-white/90 font-bold">Լավագույն Շարք</div>
                </div>
              </div>
